...
class JS_converter(object):
    ...
    def __init__(self, num_dof):
        ...
        self.l_js_sub = rospy.Subscriber("/l_arm_pos_controller/joint_imp_cmd", numpy_msg(JointStateImpedance), self.l_js_cb, queue_size=3, tcp_nodelay=True)
        ...
        self.r_js_sub = rospy.Subscriber("/r_arm_pos_controller/joint_imp_cmd", numpy_msg(JointStateImpedance), self.r_js_cb, queue_size=3, tcp_nodelay=True)
